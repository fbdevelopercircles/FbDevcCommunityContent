...
- [Wheel of Names](https://wheelofnames.com/) - Wheel of Names is an amazing tool which you can select random items (names, objects, etc) from a list, or play games with the community by spinning a wheel.
</details>
